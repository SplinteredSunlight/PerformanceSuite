...
function updateGanttChart(tasks) {
    ...
    sortedTasks.forEach(task => {
        ...
        // Make the bar draggable and resizable
        makeDraggable(bar);
        makeResizable(bar);
...
function makeDraggable(element) {
    element.addEventListener('mousedown', function(e) {
        ...
        function drag(e) {
            ...
            let newLeft = startLeft + ((e.clientX - startX) / parentWidth * 100);
...
function makeResizable(element) {
    ...
    leftHandle.addEventListener('mousedown', function(e) {
        ...
        function resize(e) {
            ...
            // Constrain to minimum width and parent bounds
            newWidth = Math.max(5, newWidth);
            newLeft = Math.max(0, Math.min(startLeft + startWidth - 5, newLeft));
    ...
    rightHandle.addEventListener('mousedown', function(e) {
        ...
        function resize(e) {
            ...
            // Constrain to minimum width and parent bounds
            newWidth = Math.max(5, Math.min(100 - parseFloat(element.style.left), newWidth));
